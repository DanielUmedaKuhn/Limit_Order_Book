...
public class MatchingEngineTest {
    ...
    void testMarketOrderClearBook(){
        ...
        engine.submitOrder(new Order(2, 110, 10, Side.SELL, OrderType.LIMIT));

        //order market deve ignorar preço e buscar liquidez
        Order marketBuy = new Order(3, 0, 15, Side.BUY, OrderType.MARKET);
    ...
    void testOrderIntegrity(){
        Order sellOrder = new Order(1, 100, 10, Side.SELL, OrderType.LIMIT);
        engine.submitOrder(sellOrder);

        Order buyOrder = new Order(2, 100, 5, Side.BUY, OrderType.LIMIT);
